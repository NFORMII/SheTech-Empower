...
const ProfilePage: React.FC = () => {
  ...
  const fetchProfileAndJournal = async () => {
    try {
      ...
      const journalRes = await api.get('/healing/journal/entries/'); // Assuming this endpoint exists for all entries
        ...
        <main className="max-w-5xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10 border border-blue-100 transform transition-all duration-500 hover:shadow-2xl">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Skills & Aspirations (relevant for Youth, IDP, and Mentors) */}
              ...
              {/* Specific Needs & Goals (Only for IDP - Not shown for Youth) */}
              {role === 'idp' && (
               ...
               {/* Achievements & Strengths (relevant for Youth, IDP) */}
               {(role === 'idp' || role === 'youth') && (
